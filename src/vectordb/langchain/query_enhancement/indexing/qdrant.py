"""Qdrant query enhancement indexing pipeline (LangChain)."""
...
class QdrantQueryEnhancementIndexingPipeline:
    """Qdrant indexing pipeline for query enhancement (LangChain).
    ...
    def __init__(self, config_or_path: dict[str, Any] | str) -> None:
        ...
        logger.info(
            "Initialized Qdrant query enhancement indexing pipeline (LangChain)"
        )
