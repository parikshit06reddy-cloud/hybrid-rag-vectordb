...
def main():
    ...
    parser = argparse.ArgumentParser(description="Query a Pinecone index using dense and sparse embeddings.")
    ...
    parser.add_argument("--index_name", default="test-index-hybrid", help="Name of the Pinecone index.")
