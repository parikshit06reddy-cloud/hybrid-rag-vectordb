"""Milvus diversity filtering indexing pipeline (LangChain)."""
...
class MilvusDiversityFilteringIndexingPipeline:
    """Milvus indexing pipeline for diversity filtering (LangChain).
    ...
    def __init__(self, config_or_path: dict[str, Any] | str) -> None:
        ...
        logger.info(
            "Initialized Milvus diversity filtering indexing pipeline (LangChain)"
        )
