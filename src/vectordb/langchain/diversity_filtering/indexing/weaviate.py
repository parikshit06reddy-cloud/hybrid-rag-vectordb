"""Weaviate diversity filtering indexing pipeline (LangChain)."""
...
class WeaviateDiversityFilteringIndexingPipeline:
    """Weaviate indexing pipeline for diversity filtering (LangChain).
    ...
    def __init__(self, config_or_path: dict[str, Any] | str) -> None:
        ...
        logger.info(
            "Initialized Weaviate diversity filtering indexing pipeline (LangChain)"
        )
