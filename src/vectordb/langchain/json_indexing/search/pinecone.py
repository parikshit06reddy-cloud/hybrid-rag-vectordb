"""Pinecone JSON search pipeline for LangChain."""
...
class PineconeJsonSearchPipeline:
    """Searches documents in Pinecone with JSON metadata filtering.
    ...
    def _setup_logging(self) -> None:
        ...
        name = logging_config.get("name", "pinecone_json_search")
    ...
    def _connect(self) -> None:
        ...
        # Store namespace for query method
