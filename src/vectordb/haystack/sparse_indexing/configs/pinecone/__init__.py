"""Configuration files for Pinecone sparse indexing pipelines.

Provides YAML configuration templates for sparse vector indexing with Pinecone database.
...
Configuration Sections:
    ...
    - retrieval: top_k, namespace, filter conditions
    - database: Pinecone connection (api_key, environment, index_name, project_name)
