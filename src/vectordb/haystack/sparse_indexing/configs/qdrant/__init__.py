"""Configuration files for Qdrant sparse indexing pipelines.

Provides YAML configuration templates for sparse vector indexing with Qdrant database.
...
Configuration Sections:
    ...
    - retrieval: top_k, filter conditions, search_params (hnsw_ef, exact)
    - database: Qdrant connection (host, port, api_key, collection_name, vector_name)
