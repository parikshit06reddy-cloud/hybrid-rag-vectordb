"""Configuration files for Milvus sparse indexing pipelines.

Provides YAML configuration templates for sparse vector indexing with Milvus database.
...
Configuration Sections:
    ...
    - retrieval: top_k, metric_type (IP/L2), nprobe for ANN search
    - database: Milvus connection (host, port, collection_name, vector_field)
