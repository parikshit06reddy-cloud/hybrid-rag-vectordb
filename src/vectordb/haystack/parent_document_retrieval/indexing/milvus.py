"""Milvus Parent Document Indexing Pipeline.
...
Pipeline Flow:
    ...
    5. Index child embeddings in Milvus vector database
...
Attributes:
    ...
    vector_db: MilvusVectorDB instance for indexing leaves
...
class MilvusParentDocIndexingPipeline:
    """Milvus indexing pipeline for parent document retrieval.

    This pipeline builds a hierarchical document index where child chunks are
    stored in Milvus for retrieval and parent documents are stored in a
    ...
    Attributes:
        ...
        vector_db: MilvusVectorDB connection for indexing leaves
    ...
    def __init__(self, config_path: str) -> None:
        ...
        hierarchical splitter, Milvus vector database, and parent document store.
    ...
    def _init_vector_db(self) -> None:
        ...
        Creates a MilvusVectorDB instance and ensures the collection exists
        ...
        index_name = db_config.get("milvus", {}).get(
            "collection_name", "parent_doc_leaves"
        )
    ...
    def run(self, limit: int | None = None) -> dict:
        ...
        stores parents in the document store, and indexes children in Milvus.
        ...
        Pipeline Steps:
            ...
            5. Embed and store leaves in Milvus vector database
        """
