"""Qdrant Parent Document Indexing Pipeline.
...
Pipeline Flow:
    ...
    5. Index child embeddings in Qdrant vector database
...
Attributes:
    ...
    vector_db: QdrantVectorDB instance for indexing leaves
...
class QdrantParentDocIndexingPipeline:
    """Qdrant indexing pipeline for parent document retrieval.

    This pipeline builds a hierarchical document index where child chunks are
    stored in Qdrant for retrieval and parent documents are stored in a
    ...
    Attributes:
        ...
        vector_db: QdrantVectorDB connection for indexing leaves
    ...
    def __init__(self, config_path: str) -> None:
        ...
        hierarchical splitter, Qdrant vector database, and parent document store.
    ...
    def _init_vector_db(self) -> None:
        ...
        Creates a QdrantVectorDB instance and ensures the collection exists
    ...
    def run(self, limit: int | None = None) -> dict:
        ...
        stores parents in the document store, and indexes children in Qdrant.
        ...
        Pipeline Steps:
            ...
            5. Embed and store leaves in Qdrant vector database
        """
