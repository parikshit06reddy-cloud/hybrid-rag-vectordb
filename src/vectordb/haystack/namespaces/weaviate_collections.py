...
def main():
    ...
    parser.add_argument("--query", type=str, required=True, help="Query string for Weaviate search.")
    ...
    weaviate_vectordb = WeaviateVectorDB(cluster_url=args.weaviate_cluster_url, api_key=args.weaviate_api_key)

    # Prepare documents for Weaviate upsert
    docs_for_weaviate = WeaviateDocumentConverter.prepare_haystack_documents_for_upsert(docs_with_embeddings)
