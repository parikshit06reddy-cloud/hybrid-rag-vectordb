"""Milvus indexing pipeline for diversity filtering feature.

Indexes documents from standard datasets into Milvus for diversity-aware
...
4. Index into Milvus with specified collection name and dimension
...
Index Management:
Creates or updates Milvus collection with specified embedding dimension.
