...
def main():
    ...
    # Query Parameters
    parser.add_argument("--dense_vector", type=float, nargs='+', required=True, help="Dense query vector")
    parser.add_argument("--sparse_vector", type=str, required=True, help="Sparse query vector as a JSON string")
