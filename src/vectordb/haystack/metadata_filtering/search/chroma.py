"""Chroma metadata filtering search pipeline for Haystack.

Performs vector search with metadata filtering on Chroma.
"""
...
__all__ = ["ChromaMetadataFilteringSearchPipeline"]

logger = logging.getLogger(__name__)


class ChromaMetadataFilteringSearchPipeline:
    """Chroma metadata filtering search pipeline.
    ...
    def __init__(self, config_or_path: str | dict) -> None:
        """Initialize Chroma search pipeline from configuration.
    ...
    def _validate_config(self) -> None:
        ...
        required_sections = ["embeddings", "chroma", "search"]
