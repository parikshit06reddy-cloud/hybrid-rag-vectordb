"""Weaviate metadata filtering search pipeline for Haystack.

Performs vector search with metadata filtering on Weaviate.
"""
...
__all__ = ["WeaviateMetadataFilteringSearchPipeline"]

logger = logging.getLogger(__name__)


class WeaviateMetadataFilteringSearchPipeline:
    """Weaviate metadata filtering search pipeline.
    ...
    def __init__(self, config_or_path: str | dict) -> None:
        """Initialize Weaviate search pipeline from configuration.
    ...
    def _validate_config(self) -> None:
        ...
        required_sections = ["embeddings", "weaviate", "search"]
    ...
    def search(self, query: str | None = None) -> list[FilteredQueryResult]:
        ...
        logger.info("Searching Weaviate...")
