"""Milvus metadata filtering search pipeline for Haystack.

Performs vector search with metadata filtering on Milvus.
"""
...
__all__ = ["MilvusMetadataFilteringSearchPipeline"]

logger = logging.getLogger(__name__)


class MilvusMetadataFilteringSearchPipeline:
    """Milvus metadata filtering search pipeline.
    ...
    def __init__(self, config_or_path: str | dict) -> None:
        """Initialize Milvus search pipeline from configuration.
    ...
    def _validate_config(self) -> None:
        ...
        required_sections = ["embeddings", "milvus", "search"]
    ...
    def search(self, query: str | None = None) -> list[FilteredQueryResult]:
        ...
        timing = TimingMetrics(
            pre_filter_ms=0.0,  # Milvus applies filtering internally
