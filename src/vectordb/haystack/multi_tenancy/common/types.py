...
class QwenEmbeddingConfig:
    ...
    dimension: int = 1024  # Default, supports 32-1024 via MRL
    output_dimension: int | None = None  # For Matryoshka Representation Learning
    device: str = "auto"  # "cpu", "cuda", "auto"
    batch_size: int = 32
    instruction: str | None = None  # Task-specific instruction (improves 1-5%)
