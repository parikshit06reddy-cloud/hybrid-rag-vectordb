"""Weaviate JSON search pipeline for Haystack."""
...
class WeaviateJSONSearcher:
    """Searches Weaviate with JSON metadata filtering.
    ...
    def search(
        ...
        where_filter = build_weaviate_filter(filters)
