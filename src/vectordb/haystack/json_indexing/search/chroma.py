"""Chroma JSON search pipeline for Haystack."""
...
from vectordb.haystack.json_indexing.common.filters.chroma import build_chroma_filter
from vectordb.utils.logging import LoggerFactory


class ChromaJSONSearcher:
    """Searches Chroma with JSON metadata filtering.
