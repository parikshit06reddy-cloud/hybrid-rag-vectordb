"""Milvus JSON indexing pipeline for Haystack."""
...
class MilvusJSONIndexer:
    """Indexes documents into Milvus with JSON metadata.
    ...
    def _setup_logging(self) -> None:
        ...
        name = logging_config.get("name", "milvus_json_indexing")
    ...
    def run(self) -> dict[str, Any]:
        ...
        self.vector_db.insert_documents(embedded_docs, collection_name)
