"""Chroma JSON indexing pipeline for Haystack."""
...
class ChromaJSONIndexer:
    """Indexes documents into Chroma with JSON metadata.
    ...
    def _setup_logging(self) -> None:
        ...
        name = logging_config.get("name", "chroma_json_indexing")
    ...
    def run(self) -> dict[str, Any]:
        ...
        self.vector_db.create_collection(collection_name=collection_name)
