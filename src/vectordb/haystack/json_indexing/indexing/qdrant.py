"""Qdrant JSON indexing pipeline for Haystack."""
...
class QdrantJSONIndexer:
    """Indexes documents into Qdrant with JSON metadata.
    ...
    def _setup_logging(self) -> None:
        ...
        name = logging_config.get("name", "qdrant_json_indexing")
