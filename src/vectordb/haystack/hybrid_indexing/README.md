...
|----------|-------------|---------------|-------|
| Pinecone | Native hybrid search | SPLADE via sentence-transformers | Sparse stored in sparse_values format |
...
| Qdrant | Native hybrid search | SPLADE via sentence-transformers | Uses named sparse vector fields |
