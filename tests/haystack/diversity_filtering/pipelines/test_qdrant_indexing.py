"""Tests for Qdrant indexing pipeline in diversity filtering."""
...
from vectordb.haystack.diversity_filtering.pipelines.qdrant_indexing import (
    load_documents,
    run_indexing,
)
...
class TestLoadDocuments:
    ...
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.qdrant_indexing.DataloaderCatalog"
    )
...
class TestRunIndexing:
    ...
    def test_run_indexing_db_initialization(
        ...
        """Test QdrantVectorDB initialization parameters."""
        config_file = tmp_path / "config.yaml"
        config_file.write_text("dummy: config")
