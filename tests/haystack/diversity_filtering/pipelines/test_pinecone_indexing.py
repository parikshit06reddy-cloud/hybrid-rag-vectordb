"""Tests for Pinecone indexing pipeline in diversity filtering."""
...
from vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing import (
    load_documents,
    run_indexing,
)
...
class TestLoadDocuments:
    ...
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing.DataloaderCatalog"
    )
...
class TestRunIndexing:
    ...
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing.PineconeVectorDB"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing.SentenceTransformersDocumentEmbedder"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing.ConfigLoader"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.pinecone_indexing.load_documents"
    )
    ...
    def test_run_indexing_db_initialization(
        ...
        """Test PineconeVectorDB initialization parameters."""
        config_file = tmp_path / "config.yaml"
        config_file.write_text("dummy: config")
