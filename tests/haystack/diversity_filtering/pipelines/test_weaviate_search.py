"""Tests for Weaviate search pipeline in diversity filtering."""
...
from vectordb.haystack.diversity_filtering.pipelines.weaviate_search import run_search
...
class TestRunSearch:
    ...
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.SentenceTransformersTextEmbedder"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.ConfigLoader"
    )
    ...
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.OpenAIGenerator"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.PromptBuilder"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.format_documents"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.get_prompt_template"
    )
    @patch(
        "vectordb.haystack.diversity_filtering.pipelines.weaviate_search.SentenceTransformersDiversityRanker"
    )
    ...
    def test_run_search_db_initialization(
        ...
        """Test WeaviateVectorDB initialization in search."""
        config_file = tmp_path / "config.yaml"
        config_file.write_text("dummy: config")
