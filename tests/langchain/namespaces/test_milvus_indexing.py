"""Tests for Milvus namespace indexing pipeline (LangChain)."""
...
class TestMilvusNamespaceIndexingPipeline:
    """Unit tests for Milvus namespace indexing pipeline."""
    ...
    def test_init_with_valid_namespace(
        self, mock_embedder, mock_db_cls, milvus_namespace_config: dict
    ):
        ...
        pipeline = MilvusNamespaceIndexingPipeline(milvus_namespace_config, "ns_123")
    ...
    def test_init_with_empty_namespace_raises_error(
        ...
        with pytest.raises(ValueError, match="namespace cannot be empty"):
            MilvusNamespaceIndexingPipeline(milvus_namespace_config, "")
