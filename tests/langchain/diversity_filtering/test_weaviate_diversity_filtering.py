...
class TestWeaviateDiversityFilteringSearch:
    ...
    def test_search_candidate_multiplier_config(
        ...
        is used to scale the top_k value when fetching candidates from Weaviate.
        ...
        Verifies:
            - Weaviate query is called with top_k * candidate_multiplier
        ...
        pipeline_default = WeaviateDiversityFilteringSearchPipeline(config_default)
        ...
        pipeline_custom = WeaviateDiversityFilteringSearchPipeline(config_custom)
