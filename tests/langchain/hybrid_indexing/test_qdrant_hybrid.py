"""Tests for Qdrant hybrid indexing and search pipelines (LangChain)."""
...
class TestQdrantHybridIndexing:
    """Unit tests for Qdrant hybrid indexing pipeline."""

    @patch("vectordb.langchain.hybrid_indexing.indexing.qdrant.QdrantVectorDB")
    @patch(
        "vectordb.langchain.hybrid_indexing.indexing.qdrant.EmbedderHelper.create_embedder"
    )
    @patch("vectordb.langchain.hybrid_indexing.indexing.qdrant.SparseEmbedder")
    @patch(
        "vectordb.langchain.hybrid_indexing.indexing.qdrant.DataloaderCatalog.create"
    )
    ...
    @patch(
        "vectordb.langchain.hybrid_indexing.indexing.qdrant.EmbedderHelper.embed_documents"
    )
    @patch("vectordb.langchain.hybrid_indexing.indexing.qdrant.SparseEmbedder")
    @patch(
        "vectordb.langchain.hybrid_indexing.indexing.qdrant.DataloaderCatalog.create"
...
class TestQdrantHybridSearch:
    """Unit tests for Qdrant hybrid search pipeline."""

    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.QdrantVectorDB")
    @patch(
        "vectordb.langchain.hybrid_indexing.search.qdrant.EmbedderHelper.create_embedder"
    )
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.SparseEmbedder")
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.RAGHelper.create_llm")
    ...
    @patch(
        "vectordb.langchain.hybrid_indexing.search.qdrant.EmbedderHelper.embed_query"
    )
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.SparseEmbedder")
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.RAGHelper.create_llm")
    ...
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.SparseEmbedder")
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.RAGHelper.create_llm")
    @patch("vectordb.langchain.hybrid_indexing.search.qdrant.RAGHelper.generate")
