"""Tests for Qdrant parent document retrieval pipelines (LangChain)."""
...
class TestQdrantParentDocumentRetrievalIndexing:
    """Unit tests for Qdrant parent document retrieval indexing pipeline."""

    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.qdrant.QdrantVectorDB"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.qdrant.EmbedderHelper.create_embedder"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.qdrant.DataloaderCatalog.create"
    )
    def test_indexing_initialization(
        ...
        pipeline = QdrantParentDocumentRetrievalIndexingPipeline(config)
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.qdrant.EmbedderHelper.embed_documents"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.qdrant.DataloaderCatalog.create"
    )
...
class TestQdrantParentDocumentRetrievalSearch:
    """Unit tests for Qdrant parent document retrieval search pipeline."""

    @patch("vectordb.langchain.parent_document_retrieval.search.qdrant.QdrantVectorDB")
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.qdrant.EmbedderHelper.create_embedder"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.qdrant.RAGHelper.create_llm"
    )
    def test_search_initialization(
        ...
        pipeline = QdrantParentDocumentRetrievalSearchPipeline(config)
        assert pipeline.config == config
        assert pipeline.collection_name == "test_parent_document_retrieval"
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.qdrant.EmbedderHelper.embed_query"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.qdrant.RAGHelper.create_llm"
    )
    ...
    def test_search_with_filters(
        ...
        assert call_kwargs.get("query_filter") == filters
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.qdrant.RAGHelper.generate"
    )
