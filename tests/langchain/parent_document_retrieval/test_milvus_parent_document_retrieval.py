"""Tests for Milvus parent document retrieval pipelines (LangChain)."""
...
class TestMilvusParentDocumentRetrievalIndexing:
    """Unit tests for Milvus parent document retrieval indexing pipeline."""

    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.milvus.MilvusVectorDB"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.milvus.EmbedderHelper.create_embedder"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.milvus.DataloaderCatalog.create"
    )
    def test_indexing_initialization(
        ...
        pipeline = MilvusParentDocumentRetrievalIndexingPipeline(config)
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.milvus.EmbedderHelper.embed_documents"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.indexing.milvus.DataloaderCatalog.create"
    )
...
class TestMilvusParentDocumentRetrievalSearch:
    """Unit tests for Milvus parent document retrieval search pipeline."""

    @patch("vectordb.langchain.parent_document_retrieval.search.milvus.MilvusVectorDB")
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.milvus.EmbedderHelper.create_embedder"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.milvus.RAGHelper.create_llm"
    )
    def test_search_initialization(
        ...
        pipeline = MilvusParentDocumentRetrievalSearchPipeline(config)
        assert pipeline.config == config
        assert pipeline.collection_name == "test_parent_document_retrieval"
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.milvus.EmbedderHelper.embed_query"
    )
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.milvus.RAGHelper.create_llm"
    )
    ...
    @patch(
        "vectordb.langchain.parent_document_retrieval.search.milvus.RAGHelper.generate"
    )
