"""Tests for Milvus reranking pipelines (LangChain)."""
...
class TestMilvusRerankingIndexing:
    """Unit tests for Milvus reranking indexing pipeline."""

    @patch("vectordb.langchain.reranking.indexing.milvus.MilvusVectorDB")
    @patch(
        "vectordb.langchain.reranking.indexing.milvus.EmbedderHelper.create_embedder"
    )
    @patch("vectordb.langchain.reranking.indexing.milvus.DataloaderCatalog.create")
    ...
    @patch(
        "vectordb.langchain.reranking.indexing.milvus.EmbedderHelper.embed_documents"
    )
    @patch("vectordb.langchain.reranking.indexing.milvus.DataloaderCatalog.create")
...
class TestMilvusRerankingSearch:
    """Unit tests for Milvus reranking search pipeline."""

    @patch("vectordb.langchain.reranking.search.milvus.MilvusVectorDB")
    @patch("vectordb.langchain.reranking.search.milvus.EmbedderHelper.create_embedder")
    @patch("vectordb.langchain.reranking.search.milvus.RAGHelper.create_llm")
    @patch("vectordb.langchain.reranking.search.milvus.RerankerHelper.create_reranker")
    ...
    @patch("vectordb.langchain.reranking.search.milvus.MilvusVectorDB")
    @patch("vectordb.langchain.reranking.search.milvus.EmbedderHelper.create_embedder")
    @patch("vectordb.langchain.reranking.search.milvus.EmbedderHelper.embed_query")
    @patch("vectordb.langchain.reranking.search.milvus.RAGHelper.create_llm")
    @patch("vectordb.langchain.reranking.search.milvus.RerankerHelper.create_reranker")
    @patch("vectordb.langchain.reranking.search.milvus.RerankerHelper.rerank")
    ...
    @patch("vectordb.langchain.reranking.search.milvus.RAGHelper.create_llm")
    @patch("vectordb.langchain.reranking.search.milvus.RerankerHelper.create_reranker")
    @patch("vectordb.langchain.reranking.search.milvus.RAGHelper.generate")
    @patch("vectordb.langchain.reranking.search.milvus.RerankerHelper.rerank")
