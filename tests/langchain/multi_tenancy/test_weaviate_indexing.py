"""Tests for Weaviate multi-tenancy indexing pipeline (LangChain)."""
...
class TestWeaviateMultiTenancyIndexingPipeline:
    """Unit tests for Weaviate multi-tenancy indexing pipeline."""
    ...
    def test_init_with_valid_tenant_id(
        self, mock_embedder, mock_db_cls, weaviate_multi_tenant_config: dict
    ):
    ...
    def test_indexing_with_limit_respects_limit(
        ...
        # Add limit to config
        weaviate_multi_tenant_config["dataloader"]["limit"] = 2
