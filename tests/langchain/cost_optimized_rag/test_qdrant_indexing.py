"""Tests for Qdrant cost-optimized RAG indexing pipeline (LangChain)."""
...
class TestQdrantCostOptimizedRAGIndexingPipeline:
    """Tests for QdrantCostOptimizedRAGIndexingPipeline."""
    ...
    def test_init_with_valid_config(
        ...
        pipeline = QdrantCostOptimizedRAGIndexingPipeline(qdrant_config)
...
chunking:
  ...
  chunk_overlap: 200
        ...
        pipeline = QdrantCostOptimizedRAGIndexingPipeline(str(config_file))
        assert pipeline is not None
